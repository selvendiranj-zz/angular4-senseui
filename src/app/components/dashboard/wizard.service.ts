...
export class WizardService
{
    public InitWizard(): any
    {
        ...
        $('#wizard-validate').steps({
            ...
            onStepChanging(event: any, currentIndex: any, newIndex: any): any
            {
            ...
            onStepChanged(event: any, currentIndex: any, priorIndex: any): any
            {
            ...
            onFinishing(event: any, currentIndex: any, newIndex: any): any
            {
