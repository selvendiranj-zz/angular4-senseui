...
export class WidgetsService
{
    public InitWidgets(): any
    {
        ...
        let plot = $.plot('#demo-site-statistics', [{
            label: 'New Visitors',
            data: visitors
        }], {
                series: {
        ...
        plot = $.plot('#demo-order-statistics', [{
            label: 'New Orders',
            data: orders
        }], {
                series: {
        ...
        plot = $.plot('#demo-sales-statistics', [{
            label: 'New Orders',
            data: sales
        }], {
                series: {
        ...
        plot = $.plot('#demo-feedback-statistics', [{
        ...
        plot = $.plot('#demo-earning-statistics', [{
            label: 'Net Earning',
            data: earning
        }], {
                series: {
        ...
        plot = $.plot('#demo-performance-statistics', [{
        ...
        $('#demo-pie-2').easyPieChart({
            ...
            size: '70',
            lineWidth: 8,
            onStep(from: any, to: any, percent: any): any
            {
        ...
        let skycons = new Skycons(skyconsOptions);
        skycons.add('demo-weather-lg-icon-1', Skycons.RAIN);
        skycons.play();

        let skycons2 = new Skycons(skyconsOptions);
