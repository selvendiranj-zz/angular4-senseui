...
export class ValidationService
{
    public InitValidation(): any
    {
        ...
        //		if (tabId) {
        //		let $icon = $('a[href="#' + tabId + '"][data-toggle="tab"]').parent().find('i');

        // Add custom class to tab containing the field
        //		if (data.status == validator.STATUS_INVALID) {
        //			$icon.removeClass(faIcon.valid).addClass(faIcon.invalid);
        //		} else if (data.status == validator.STATUS_VALID) {
        //			let isValidTab = validator.isValidContainer($tabPane);
        ...
        // =================================================================
        //	$('#demo-accordion-validation').bootstrapValidator({
        ...
        // 		if (colId) {
        // 		let $anchor = $('a[href="#' + colId + '"][data-toggle="collapse"]');
        ...
        // 			$icon.removeClass(faIcon.valid).addClass(faIcon.invalid);
        // 		} else if (data.status == validator.STATUS_VALID) {
        // 			let isValidCol = validator.isValidContainer($collapsePane);
        // 			if (isValidCol) {
        ...
        $('#demo-custom-container').bootstrapValidator(custCont);
    }
}
